 ...
 */
 Producer.prototype.initTransactions = function(timeout) {
  ...
  return this._errorWrap(this._client.initTransactions(timeout));
};
 ...
 */
  Producer.prototype.beginTransaction = function() {
   return this._errorWrap(this._client.beginTransaction());
};
 ...
 */
 Producer.prototype.commitTransaction = function(timeout) {
  ...
  return this._errorWrap(this._client.commitTransaction(timeout));
};
 ...
 */
 Producer.prototype.abortTransaction = function(timeout) {
  ...
  return this._errorWrap(this._client.abortTransaction(timeout));
};
