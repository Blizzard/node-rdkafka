 ...
 *
 * @param {number} timeout - Number of milliseconds to try to initialize before giving up.
 *                           defaults to 5 seconds.
 * @return {Producer} - returns itself.
 */
 Producer.prototype.initTransactions = function(timeout) {
  if (timeout === undefined || timeout === null) {
    timeout = 5000;
  }

  return this._errorWrapTxn(this._client.initTransactions(timeout));
};
 ...
 */
  Producer.prototype.beginTransaction = function() {
   return this._errorWrapTxn(this._client.beginTransaction());
};
 ...
 * @return {Producer} - returns itself.
 */
 Producer.prototype.commitTransaction = function(timeout) {
  if (timeout === undefined || timeout === null) {
    timeout = 5000;
  }

  return this._errorWrapTxn(this._client.commitTransaction(timeout));
};
 ...
 * @return {Producer} - returns itself.
 */
 Producer.prototype.abortTransaction = function(timeout) {
  if (timeout === undefined || timeout === null) {
    timeout = 5000;
  }

  return this._errorWrapTxn(this._client.abortTransaction(timeout));
};
 ...
 * @param {number} timeout - Number of milliseconds to try to send offsets
 * @return {Producer} - returns itself.
 */
 Producer.prototype.sendOffsetsToTransaction = function(offsets, consumer, timeout) {
  if (timeout === undefined || timeout === null) {
    timeout = 5000;
  }
  ...
  return this._errorWrapTxn(this._client.sendOffsetsToTransaction(offsets, consumer, timeout));
};
