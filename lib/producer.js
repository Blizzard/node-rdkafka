 ...
 */
 Producer.prototype.initTransactions = function(timeout) {
  ...
  this._errorWrapTxn(this._client.initTransactions(timeout));
};
 ...
 */
  Producer.prototype.beginTransaction = function() {
   this._errorWrapTxn(this._client.beginTransaction());
};
 ...
 */
 Producer.prototype.commitTransaction = function(timeout) {
  ...
  this._errorWrapTxn(this._client.commitTransaction(timeout));
};
 ...
 */
 Producer.prototype.abortTransaction = function(timeout) {
  ...
  this._errorWrapTxn(this._client.abortTransaction(timeout));
};
 ...
 */
 Producer.prototype.sendOffsetsToTransaction = function(offsets, consumer, timeout) {
  ...
  this._errorWrapTxn(this._client.sendOffsetsToTransaction(offsets, consumer.getClient(), timeout));
};
