...
function Producer(conf, topicConf) {
  ...
  // only carry a boolean for this setting
  this.automaticOpaque = conf.dr_msg_cb ? true : false;
...
Producer.prototype.produce = function(topic, partition, message, key, opaque) {
  ...
  if (opaque === undefined && this.automaticOpaque) {
    opaque = { 'key': key, 'value' : message };
  }
