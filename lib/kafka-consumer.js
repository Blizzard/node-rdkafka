 ...
 * stream backpressure.
 * @param {Array|string|null} topics - Array of topics or a topic string to
 * subscribe to. If null is provided, it will not automatically subscribe.
...
KafkaConsumer.prototype.consume = function(topics, cb) {
  ...
  if (topics === null || (topics && (Array.isArray(topics) || (typeof topics === 'string' || topics instanceof RegExp)))) {
