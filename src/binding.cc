...
void ConstantsInit(v8::Local<v8::Object> exports) {
  ...
  NODE_DEFINE_CONSTANT(constants, ErrorCode::ERR_GROUP_COORDINATOR_NOT_AVAILABLE);
  ...
  NODE_DEFINE_CONSTANT(constants, ErrorCode::ERR_NOT_ENOUGH_REPLICAS_AFTER_APPEND);
